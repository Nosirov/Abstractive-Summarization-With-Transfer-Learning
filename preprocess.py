...
class CNNDailymail(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_file(os.path.join(data_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/train_story.txt")),self._read_file(os.path.join(data_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/train_summ.txt")),
            "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_file(os.path.join(data_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/eval_story.txt")),self._read_file(os.path.join(data_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/eval_summ.txt")),
            "dev")
...
def get_dataset(processor,
    ...
    if mode == 'train':
        ...
        train_file = os.path.join(output_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/train.tf_record")
        ...
        eval_file = os.path.join(output_dir, "/content/Abstractive-Summarization-With-Transfer-Learning/data/eval.tf_record")
